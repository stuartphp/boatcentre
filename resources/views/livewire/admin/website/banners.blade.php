<div>
    <div class="card">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
            <div class="row">
                <div class="col"><a href="#" wire:click.prevent="loadModal('add', 0)">Add</a></div>
                <div class="col">
        ...
        <tbody>
            @foreach ($data as $item)
                <tr>
                    ...
                    <td><select class="form-select form-select-sm" wire:change="loadModal($event.target.value, {{ $item->id }})">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        @if ($image>'')
          <img src="/images/{{ $image }}" style="width:460px"/>
          <div class="mb-3">
