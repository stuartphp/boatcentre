<div class="ms-1 me-1">
    ...
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-7">
                    <div class="card-title">Dealers&nbsp;<div wire:loading class="text-warning">Loading Record...</div></div>
                </div>
                <div class="col-5">
                    <div class="row">
    ...
    <div class="modal-dialog">
        ...
        <div class="@if($action=='delete') d-none @else d-block @endif">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control form-control-sm" id="logo" wire:model="logo">
            </div>
            <div class="mb-3">
